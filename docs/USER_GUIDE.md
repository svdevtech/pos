...
4. **แป้นตัวเลขในหน้าต่าง** (เฉพาะแท็บเล็ต/มือถือ): แตะช่องจำนวนเงินที่ต้องการแก้ (ช่องที่กำลังแก้จะมีกรอบสีฟ้า) แล้วกดตัวเลขบนแป้นในหน้าต่าง — **⌫** ลบทีละตัว **C** ล้างทั้งช่อง ระบบไม่เรียกคีย์บอร์ดของเครื่องขึ้นมา หน้าต่างจึงไม่ถูกบีบ (ดูข้อ 20.3) บนคอมพิวเตอร์ยังพิมพ์ด้วยคีย์บอร์ดได้ตามปกติ
...
| พฤติกรรมหน้าขาย | **ต้องเปิดกะก่อนขาย**, **อนุญาตแก้ราคาที่หน้าขาย**, **อนุญาตขายเมื่อสต็อกไม่พอ** |
...
- **หน้าต่างชำระเงินมีแป้นตัวเลขในตัว** จึงไม่เรียกคีย์บอร์ดของ iPad ขึ้นมาบังจอ แตะช่องจำนวนเงินแล้วกดตัวเลขบนแป้นได้เลย (**⌫** ลบทีละตัว, **C** ล้างช่อง)
