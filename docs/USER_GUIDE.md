...
4. **เพิ่มช่องทางชำระ** เพื่อแบ่งจ่ายหลายวิธีในบิลเดียว (เช่น โอน 100 + เงินสดที่เหลือ)
5. ระบบแสดง **เงินทอน** (สีเขียว) หรือ **ขาดอีก** (สีแดง) ตามเวลาจริง กด **รับเงิน (Enter)** เมื่อครบ
...
- เมื่อแตะช่องกรอกตัวเลขแล้วคีย์บอร์ดขึ้นมา หน้าต่าง (modal) จะย่อให้พอดีกับพื้นที่ที่เหลือโดยอัตโนมัติ เลื่อนดูเนื้อหาในหน้าต่างได้ และปุ่ม **รับเงิน / ยกเลิก** จะอยู่ในจอเสมอ
