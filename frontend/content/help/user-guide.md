...
**1) สำรองข้อมูล** กด **สร้างไฟล์สำรองข้อมูล** ระบบจะรวมข้อมูลทั้งร้าน (สินค้า บาร์โค้ด สมาชิก หุ้น การขายทุกบิลพร้อมรายการ ลูกหนี้ การรับสินค้า สต็อก ค่าใช้จ่าย ปันผล ผู้ใช้งาน และการตั้งค่า) เป็นไฟล์ `.zip` เก็บไว้บนเซิร์ฟเวอร์ กด ⬇ เพื่อดาวน์โหลดเก็บไว้ที่อื่น (แนะนำให้ดาวน์โหลดเก็บนอกเซิร์ฟเวอร์อย่างน้อยเดือนละครั้ง) ระบบเก็บไฟล์ล่าสุดไว้ 20 ไฟล์ ไฟล์เก่ากว่านั้นถูกลบอัตโนมัติ
