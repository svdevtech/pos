...
1. เปิดเว็บ (เช่น `http://192.168.1.120:3010`) จะพบหน้า **เข้าสู่ระบบ**
...
```
┌ ชื่อร้าน · ผู้ใช้ · วันเวลา · TH/EN ───────────────────────────────────────────────┐
│ [สมาชิก F3] [สถานะกะ]   [พักบิล][เรียกบิลที่พัก][บิล][พิมพ์ซ้ำ][ยกเลิกการขาย][เปิดลิ้นชัก] │
│ ตะกร้าสินค้า                                     │ สแกนบาร์โค้ดหรือค้นหาสินค้า        │
│ # สินค้า  ราคา  จำนวน  ส่วนลด  รวม               │ ส่วนลดท้ายบิล (฿ / %)  หมายเหตุ    │
│ ...                                             │ รายการ (n)   ยอดสุทธิ ฿ ….       │
│                                                 │ [ ชำระเงิน (F9) ]                 │
│                                                 │ F1 ค้นหา · F2 พักบิล · F3 สมาชิก …  │
└──────────────────────────────────────────────────────────────────────────────────────┘
```
...
เมื่อสำเร็จ: ขึ้น "บันทึกการขาย N6609-00012 แล้ว", เปิดหน้าต่าง **ใบเสร็จ** (พิมพ์อัตโนมัติถ้าเปิด **พิมพ์ใบเสร็จอัตโนมัติ**) และกด **ขายใหม่** (Enter) เพื่อเริ่มบิลถัดไป
...
| กลุ่ม | ตัวเลือก |
|---|---|
| รูปแบบใบเสร็จ | **ความกว้างกระดาษ** 58/80 มม., **ภาษาใบเสร็จ**, **แสดงโลโก้บนใบเสร็จ** |
